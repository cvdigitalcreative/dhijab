          ...
          <div class="card-body">
            <div class="col-xl-12 mb-10" style="display: flex;">
              <div class="col-xl-12 mb-10" style="display: flex">
                ...
                <div class="col-md-6">
                  <a href="<?php echo base_url()?>Order/Pemesanan/Cetak_Invoice/<?php echo $p_id?>/<?php echo $lvl?>" target="blank" class="btn btn-primary btn-block ripple m-t-20">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="kurir">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Order/Pemesanan/tambahpesananNR" method="post" enctype="multipart/form-data">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $lb_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url()?>Order/Pemesanan/hapuspesananlb" method="post">
                            <div class="row">
                                <div class="col-md-12">
