            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <center><a href="<?php echo base_url()?>Order/Stock/History/<?php echo $barang_id?>" data-toggle="tooltip" data-placement="top" title="Lihat History Stock"><span class="ti-eye"></span></a></center>
                      </td>
                    </tr>
                    <?php endforeach;?>
              </tbody>
...
<script type="text/javascript">
  ...
  $('#submit').click(function(){    
    $.ajax({
      url:"<?php echo base_url()?>Order/Barang",
      method:"POST",
