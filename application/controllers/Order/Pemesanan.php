		...
		function __construct()
	  	...
	  	function index(){
	  		if($this->session->userdata('akses') == 3 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('order/v_pemesanan',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function savepemesananNR(){
 	  	...
 	  	function tambahpesananNR(){
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect("Order/Pemesanan/list_barang/$pemesanan_id/$level");		  	
 	  	}
 	  	...
 	  	function list_barang($pemesanan_id){
 	  		if($this->session->userdata('akses') == 3 && $this->session->userdata('masuk') == true){
 	  		   ...
 	  		   if($level == 3){
			       ...
			       $this->load->view('v_header',$y);
			       $this->load->view('order/v_sidebar');
			       $this->load->view('order/v_list_barang1',$x);
 	  		   }elseif($level == 3){
 	  		   	   $y['title'] = "List Barang Pemesan";
 	  		   	   $x['p_id'] = $pemesanan_id;
 	  		   	   $x['lvl'] =$level;	
			       ...
			       $this->load->view('v_header',$y);
			       $this->load->view('order/v_sidebar');
			       $this->load->view('order/v_list_barang',$x);		
 	  		   }
 	  	...
 	  	function Cetak_Invoice($pemesanan_id){
 	  		$level = $this->uri->segment(5);
 	  		   if($level == 1){
			       ...
			       $this->load->view('order/v_cetak_invoice',$x);
 	  		   }elseif($level == 3){
 	  		   	   $y['title'] = "List Barang Pemesan";
 	  		   	   $x['p_id'] = $pemesanan_id;
 	  		   	   $x['lvl'] =$level;	
	  	...
	  	function asal_transaksi(){
	  		if($this->session->userdata('akses') == 3 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_asal_transaksi',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function saveAT(){
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect('Order/Pemesanan/asal_transaksi');
	  	}
	  	...
	  	function kurir(){
	  		if($this->session->userdata('akses') == 3 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_kurir',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function savekurir(){
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect('Order/Pemesanan/kurir');
	  	}
	  	...
	  	function metode_pembayaran(){
	  		if($this->session->userdata('akses') == 3 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_metode_pembayaran',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function saveMetodePembayaran(){
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect('Order/Pemesanan/metode_pembayaran');
	  	}
