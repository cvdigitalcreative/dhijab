		...
		function __construct()
	  	...
	  	function index(){
	  		if($this->session->userdata('akses') == 1 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('order/v_barang_non_reseller',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function pemesanan(){
	  		if($this->session->userdata('akses') == 1 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_pemesanan_o',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function tambahpesananNR(){
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect("Order/Barang/list_barang/$pemesanan_id/$level");		  	
 	  	}
	  	...
	  	function savepemesananNR(){
			...
			$pemesanan_id=$z['pemesanan_id'];
	  		...
	  		echo $this->session->set_flashdata('msg','success');
	       	redirect('Order/Barang/pemesanan');		  	
 	  	}
	  	...
	  	function Reseller(){
	  		if($this->session->userdata('akses') == 1 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_barang_reseller',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function Harga_Reseller($barang_id){
	  		if($this->session->userdata('akses') == 1 && $this->session->userdata('masuk') == true){
		       ...
		       $this->load->view('v_header',$y);
		       $this->load->view('order/v_sidebar');
		       $this->load->view('order/v_harga_reseller',$x);
		    }
		    else{
		       redirect('Login');
		    }
	  	...
	  	function update_harga_reseller(){
			...
			echo $this->session->set_flashdata('msg','update');
	        redirect("Order/Barang/Harga_Reseller/$barang_id");
	  	}
	  	...
	  	function s_barang_reseller(){
			...
			echo $this->session->set_flashdata('msg','success');
	        redirect('Order/Barang/Reseller');
	  	}
